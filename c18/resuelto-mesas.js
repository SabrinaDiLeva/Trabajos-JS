...
const aceptaMascotas = inmobiliaria.filtrarPetFriendly();
inmobiliaria.listarDepartamentos(aceptaMascotas);
console.log(o);

console.log(v, oo + " C. rebajasPorNoAlquiler");
const rebajados = inmobiliaria.rebajasPorNoAlquiler();
inmobiliaria.listarDepartamentos(rebajados);
console.log(o);

console.log(v, oo + " D. buscarPorPropietarios");
const porNombres = inmobiliaria.buscarPorPropietarios("Luis Perez");
inmobiliaria.listarDepartamentos(porNombres);
console.log(o);
